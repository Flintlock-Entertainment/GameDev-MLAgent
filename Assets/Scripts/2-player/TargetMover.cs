...
public class TargetMover: MonoBehaviour {
    ...
    [SerializeField] public AllowedTiles allowedTiles = null;
    ...
    [SerializeField] public Vector3 targetInWorld;

    [Tooltip("The target position in grid coordinates")]
    [SerializeField] Vector3Int targetInGrid;

    public bool atTarget { get; protected set; }  // This property is set to "true" whenever the object has already found the target.
